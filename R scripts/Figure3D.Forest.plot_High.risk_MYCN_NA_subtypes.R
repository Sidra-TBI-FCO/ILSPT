...
HR_table = read.csv("./Analysis/after_split/Survival_Analysis/HR_NBL_High_for_forest_plot.csv",stringsAsFactors = FALSE)
...
pdf(file = paste0("./Figures/after_split/Forest_plots/Thorss_clusters_Forest/024a.High_risk_MYCN_NA_NBL_subgroups_cutoff_", Surv.cutoff.years,".pdf"),
    height = 5, width = 5)
